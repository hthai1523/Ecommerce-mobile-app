    ...
    <SafeAreaView className=" w-full h-16 border-t border-t-[#EEE]">
      ...
      <View className=" flex-row items-center gap-4 px-[3] py-2">
        ...
        <TouchableOpacity
          ...
          className="px-16 py-5 rounded flex-row items-center justify-center gap-2 relative"
          style={{ backgroundColor: Colors.primary.background }}
        >
          <Feather name="shopping-cart" size={24} color="white" />
          <Text className="text-base font-medium text-white">Checkout</Text>
          {products.length > 0 && (
            <View className="absolute w-6 h-6 rounded-full border-2 border-white bg-red-400 transition-all right-0 top-0">
