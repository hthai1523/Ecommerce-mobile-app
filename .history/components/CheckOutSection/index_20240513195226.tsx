      ...
      <View className="mt-9 flex flex-row items-center">
        ...
        <View className="flex-1">
          ...
          <View className="flex flex-row justify-between items-center">
            <Text className="text-base font-light text-black/30">{formatCurrency(item.price * quantity / 3)}</Text>
            <Text className="text-base font-light text-black/30">x {quantity}</Text>
          </View>
        </View>
      </View>
    </View>
