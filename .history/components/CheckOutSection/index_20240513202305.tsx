  ...
  return (
    <View className="flex flex-col bg-white mt-4">
      ...
      <View className="flex flex-row items-center px-4 py-5">
        ...
        <View className="flex-row items-center justify-between px-4 py-2 border-t border-t-[#EEE]">
          ...
          <TouchableOpacity className="flex-row items-center gap-3">
            <View className="border-2" style={{borderColor: Colors.primary.background}}>
