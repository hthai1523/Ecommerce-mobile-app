    ...
    <View className="flex flex-col p-4 bg-white">
      ...
      <View className="mt-9 flex flex-row items-center">
        ...
        <View className="flex-1">
          ...
          <View className="border border-2" style={{borderColor: Colors.primary.background, width: 90}} >
            <Text className="text-sky-400 text-center text-sm font-medium">Free return</Text>
          </View>
        </View>
      </View>
    </View>
