    ...
    <View className="flex flex-col p-4 bg-white">
      ...
      <View className="mt-9 flex flex-row items-center">
        ...
        <View className="flex-1">
          ...
          <View className="border-2" style={{borderColor: Colors.primary.background, width: 80}} >
            <Text className="text-sky-400 text-center text-xs font-medium">Free return</Text>
          </View>
          <Text className="text-[#ADADAD] text-base font-light">Options: Blue, L</Text>
        </View>
      </View>
    </View>
  );
