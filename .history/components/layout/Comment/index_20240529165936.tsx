...
const Comment = () => {
  return (
    <View style={styles.container}>
      ...
      <View className="w-full my-2 flex-row items-center bg-slate-100">
        <TextInput
          className="flex-1 px-3 py-2 text-sky-700 border-r border-r-black/70"
          selectionColor={Colors.primary.icon}
          placeholder="Add a review"
          placeholderTextColor={Colors.primary.icon}
        />
        <TouchableOpacity className="p-3 bg-sla">
