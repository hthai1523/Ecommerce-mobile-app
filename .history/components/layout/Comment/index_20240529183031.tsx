...
import Animated, { BounceInDown, BounceInLeft, FadeInDown } from "react-native-reanimated";
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <TouchableOpacity style={styles.seeAllButton} onPress={() => setToggleInput(prev => !prev)}>
      ...
      {toggleInput && (
        <Animated.View
          entering={BounceInLeft.delay(100).duration(500).springify()}
