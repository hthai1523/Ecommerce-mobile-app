  ...
  return (
    <SafeAreaView className="flex-1">
      <View className="bg-white h-[53px] flex flex-row items-center justify-between border-b border-b-[#EEE]">
        ...
        <View className="flex-row min-w-[239] items-center px-3 ml-3 rounded-md bg-sky-300 ">
          <TouchableOpacity>
            <Feather name="search" size={20} color={"#fff"} />
          </TouchableOpacity>
          <Link href={"/(modals)/search"} asChild>
            <Pressable className="px-2 py-2 flex-1">
              <Text className="text-white">Search Anything</Text>
            </Pressable>
          </Link>
        </View>
        <View className="flex-row items-center justify-between mr-[6px]">
          <TouchableOpacity className="p-[6px]">
            <Feather name="bell" size={20} color={Colors.primary.background} />
          </TouchableOpacity>
          <TouchableOpacity className="p-[6px]">
            <Feather name="mail" size={20} color={Colors.primary.background} />
          </TouchableOpacity>
          <TouchableOpacity className="p-[6px]">
            <Feather name="heart" size={20} color={Colors.primary.background} />
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
