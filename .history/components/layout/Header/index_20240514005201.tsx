  ...
  return (
    <SafeAreaView className="flex-1">
      <View className="bg-white h-[53px] flex flex-row items-center justify-between border-b border-b-[#EEE]">
        ...
        <View className="flex-row min-w-[239] items-center px-3 ml-3 rounded-md bg-slate-100 ">
          <TouchableOpacity>
            <Feather name="search" size={20} color={Colors.primary.icon} />
          </TouchableOpacity>
          <Link href={"/(modals)/search"} asChild>
            <Pressable className="px-2 py-2 flex-1">
              <Text className="text-sky-700">Search Anything</Text>
            </Pressable>
          </Link>
        </View>
        <View className="flex-row items-center justify-between mr-[6px]">
          ...
          <TouchableOpacity onPress={() => router.navigate('/(modals)/Cart')} className="p-[6px]">
            <Feather name="shopping-cart" size={20} color={Colors.primary.icon} />
          </TouchableOpacity>
        </View>
      </View>
    </SafeAreaView>
