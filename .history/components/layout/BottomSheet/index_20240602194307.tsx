...
import { Product, ProductDetail } from "@/store/interfaces";
...
const sizes = ['M', 'L', 'XL']
const colors = [' rgb(239 68 68)', 'rgb(59 130 246)', 'rgb(234 179 8)', '#000']

const BottomSheet = forwardRef<Ref, { dismiss: () => void } & Product>((props, ref) => {
  ...
  return (
    ...
    >
      <BottomSheetView style={{ flex: 1 }}>
        <View className="border-b border-b-[#EEE] text-yellow-500 p-4 flex-row space-x-2">
        ...
        <TouchableOpacity
          ...
          className="p-4 border-t border-t-[#EEE]"
        >
