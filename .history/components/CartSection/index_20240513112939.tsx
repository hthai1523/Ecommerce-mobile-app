...
const CartSection = ({
  ...
  const gestureHandler = useAnimatedGestureHandler<PanGestureHandlerGestureEvent>({
    ...
    onEnd: (e) => {
      if (TRANSLATE_X_THRESHOLD < e.translationX) {
  ...
  return (
    <Animated.View
      style={[styles.shadow, styles.container, itemContainerStyle]}
    >
      <Animated.View style={[styles.iconConatiner, rTaskContainerStyle]}>
        <Feather
          name={'trash-2'}
      ...
      <PanGestureHandler onGestureEvent={gestureHandler} simultaneousHandlers={}>
