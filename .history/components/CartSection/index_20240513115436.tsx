...
const CartSection = ({
  ...
  const trashIconWidth = useSharedValue(ITEM_HEIGHT); // Initial width same as ITEM_HEIGHT

  const gestureHandler = useAnimatedGestureHandler<PanGestureHandlerGestureEvent>({
    onActive: (e) => {
      translateX.value = e.translationX;
      trashIconWidth.value = withTiming(
        ITEM_HEIGHT - e.translationX, // Adjust width based on translation
        { duration: 0 }
      );
    },
    onEnd: () => {
  ...
  return (
    ...
    >
      <Animated.View style={[styles.iconConatiner, rIconContainerStyle, { width: trashIconWidth.value }]}>
        <Feather
          name={'trash-2'}
