            ...
            <View className="h-full w-full justify-around pt-40 pb-10">
                ...
                <View className="flex items-center mx-4 space-y-4">
                    ...
                    <View className="w-full flex flex-row items-center">
                        <Animated.View entering={FadeInDown.delay(400).duration(1000).springify()} className="w-1/2 mr-1">
                            <TouchableOpacity className="w-full bg-sky-400 p-3 rounded-2xl">
                                <Text className="text-xl font-bold text-white text-center">Login</Text>
                            </TouchableOpacity>
                        </Animated.View>
                        <Animated.View entering={FadeInDown.delay(400).duration(1000).springify()} className="w-1/2 ml-1">
                            <TouchableOpacity className="w-full bg-sky-400 p-3 rounded-2xl">
                                <Text className="text-xl font-bold text-white text-center">Login</Text>
                            </TouchableOpacity>
                        </Animated.View>
