    ...
    <>
      ...
      {!order && (
        <>
          ...
          <SafeAreaView edges='bottom' className="flex-row items-center justify-end bg-white ">
            <View className="py-2 mx-3">
              <Text className="text-base text-black/70">Total payment</Text>
              <Text className="text-lg font-bold text-sky-400">{formatCurrency(totalPrice())}</Text>
            </View>
            <TouchableOpacity className="h-full py-4 bg-sky-400 flex-row items-center justify-center " style={{width: 112}}>
