...
const Page: React.FC = () => {
  ...
  const [address, setAddress] = useState<LocationGeocodedAddress | null>(null); // Initialize address state
  ...
  const selectAddress = (value: LocationGeocodedAddress) => {
    setAddress(value);
  };
          ...
          <ScrollView style={styles.container}>
            ...
            <Link
              href={{
                ...
                params: { setAddress: selectAddress }, // Pass the callback as a prop
              }}
              asChild
              style={{ marginTop: 12 }}
            >
