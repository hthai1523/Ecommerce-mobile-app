...
const Page: React.FC = () => {
  ...
  (function() {
    address && return  (Toast.show({
      type: 'success',
      text1: 'Address Selected',
      text2: 'Your address has been successfully selected.'
    });)
  })()
        ...
        <>
          <ScrollView style={styles.container}>
            <View style={styles.shippingContainer}>
              ...
              <Text style={styles.shippingText}>Free shipping code applied</Text>
            </View>

            <Link href="/(modals)/location-search" asChild style={{ marginTop: 12 }}>
              <TouchableOpacity style={styles.addressContainer}>
                <View style={styles.addressInnerContainer}>
                  <FontAwesome6 name="location-dot" size={24} color={"red"} />
                  <Text style={styles.addressText}>
                    {address ? `${address.street}, ${address.city}` : "Select address"}
                  </Text>
                </View>
            ...
            <FlatList
              ...
              renderItem={({ item }) => <CheckoutSection item={item} quantity={item.quantity} />}
              scrollEnabled={false}
