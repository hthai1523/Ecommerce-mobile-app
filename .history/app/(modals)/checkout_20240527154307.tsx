    ...
    <>
      ...
      {!order && (
        <>
          ...
          <SafeAreaView edges='bottom' className="flex-row items-center justify-end bg-white " style={{height: 64}}>
            <View className=" mx-3">
              <Text className="text-base text-black/70">Total payment</Text>
              <Text className="text-lg font-bold text-sky-400 text-right">{formatCurrency(totalPrice())}</Text>
            </View>
            <TouchableOpacity className="h-full bg-sky-400 flex-row items-center justify-center " style={{width: 112}}>
