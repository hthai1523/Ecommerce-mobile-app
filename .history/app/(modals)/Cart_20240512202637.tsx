      ...
      <SafeAreaView className="w-full bg-white">
        ...
        <View className="flex-row items-center justify-between ">
          <View className="py-3  px-2">
            <Text className="text-sm font-extralight mr-2">Total payment <Text className="text-sky-400 font-bold text-lg">{formatCurrency(totalPriceCart())}</Text></Text>
            <Text className="text-sm font-extralight mr-2">Saving<Text className="text-sky-400 font-normal text-base">{formatCurrency(totalPriceCart() / 3)}</Text></Text>
          </View>
          <TouchableOpacity className="h-full px-5 bg-sky-400 flex-row items-center">
