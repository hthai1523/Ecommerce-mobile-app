...
const NewList = () => {
    ...
    const handleWishlistToggle = (product: Product) => {
        setListProduct((prevList) => {
            if (prevList.some(p => p.productID === product.productID)) {
                return prevList.filter(p => p.productID !== product.productID);
            } else {
    ...
    const isProductInWishlist = (productId: number) => {
        return listProduct.some(product => product.productID === productId);
    };
