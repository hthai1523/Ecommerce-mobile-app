      ...
      <SafeAreaView className="w-full bg-white">
        ...
        <View className="flex-row items-center justify-between ">
          <View className="py-3  px-2">
            <Text className="text-sm font-extralight">Total payment <Text className="text-sky-400 font-bold">{formatCurrency(totalPriceCart())}</Text></Text>
            <Text className="text-sm font-extralight">Saving<Text className="text-sky-400 font-bold">{formatCurrency(totalPriceCart() / 3)}</Text></Text>
          </View>
