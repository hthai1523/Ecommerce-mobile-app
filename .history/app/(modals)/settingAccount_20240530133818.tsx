    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: "white" }}>
      <ScrollView className="w-full">
        ...
        <View className="px-4">
          ...
          <View className=" border-b border-b-sky-400">
            <View className="flex-row items-center justify-between pb-2">
              ...
              <TouchableOpacity onPress={() => setToggleInput(prev => !prev)} ><Text className="font-semibold">Click to change</Text></TouchableOpacity>
            </View>
            {toggleInput && <Animated.View
