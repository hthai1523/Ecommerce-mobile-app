        ...
        <View className="h-full w-full justify-around pt-44">
          ...
          <View className="flex items-center mx-4 space-y-4">
            ...
            >
              ...
              />
              {emailErrorMessage ? (
                <Text style={{ color: 'red', marginTop: 5 }}>{emailErrorMessage}</Text>
              ) : null}
            </Animated.View>
            <Animated.View
            ...
            >
              ...
              {passwordErrorMessage ? (
                <Text style={{ color: 'red', marginTop: 5 }}>{passwordErrorMessage}</Text>
              ) : null}
            </Animated.View>

            {generalErrorMessage ? (
              <Text style={{ color: 'red', textAlign: 'center' }}>{generalErrorMessage}</Text>
            ) : null}
