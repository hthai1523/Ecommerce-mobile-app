  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView className="p-4">
        ...
        <View className="my-4  rounded-lg " style={{overflow: 'hidden'}}>
          <Text className="text-lg font-extrabold">Featured Products</Text>
          <Image source={require('@/assets/images/feedImage.jpg')} style={{width: '100%', height: 400, objectFit: 'cover', position: 'relative'}}  />
