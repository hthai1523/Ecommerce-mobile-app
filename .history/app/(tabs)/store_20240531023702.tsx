...
const Store = () => {
  ...
  const [sortAscending, setSortAscending] = useState(true); // State để lưu trạng thái sắp xếp
  ...
  const toggleSort = () => {
    ...
    const sortedProducts = product.sort((a, b) => {
      ...
      return sortAscending ? priceRealA - priceRealB : priceRealA - priceRealB;
    });
        ...
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <View className="space-y-6 mx-4">
            <View className="flex-row items-center justify-between">
              ...
              <TouchableOpacity onPress={toggleSort}><FontAwesome  name="sort-numeric-asc" size={24} color="black" /></TouchableOpacity>
            </View>
