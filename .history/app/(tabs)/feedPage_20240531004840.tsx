    ...
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView className="p-4">
              ...
              <View key={index} style={styles.cardContainer}>
                ...
                <View className="px-2 py-2 w-full ">
                  ...
                  <View className="flex-row flex-wrap items-center gap-2 mt-1">
                    {item.tag.map((tag) => (
                      <View className="bg-sky-400  p-1 rounded-sm">
        ...
        <View className="my-4 space-y-4 ">
          ...
          <View style={styles.featuredContainer} className="space-y-2 pb-4">
            <View className="relative overflow-hidden rounded-md ">
              <Image source={require('@/assets/images/feedImage.jpg')} style={{width: '100%', height: 400, objectFit: 'cover' }}  />
              <Text className="absolute top-0 left-0 bg-sky-400 text-white p-1 ">Limited Edition</Text>
            </View>
            <View className="space-y-2 px-2">
              <Text className="text-xs">Summer Chic Dress</Text>
              <Text className="font-bold">{formatCurrency(59.99)}</Text>
              <Text>🛒</Text>
            </View>
          </View>
          <View style={styles.featuredContainer} className="space-y-2 pb-4">
        ...
        <View className="my-4 space-y-4">
            <Text className="text-lg font-extrabold">Fashion Articles</Text>
            <View className="flex-row w-full space-x-3 border-b border-b-black/20 py-4">
              <Image source={{uri: 'https://th.bing.com/th/id/OIP.MkqxKliP-coG1uCo7Hin3AHaFj?rs=1&pid=ImgDetMain'}} style={{width: 100, height: 100, objectFit: 'cover'}} />
              <View className="flex-1">
                <Text>10 Must-Have Accessories</Text>
                <Text>Complete your look with these essentials</Text>
                <View className="flex-row items-center gap-2">
                  <View className="bg-sky-400  p-1 rounded-sm"><Text className="text-white">Accessories</Text></View>
                  <View className="bg-sky-400  p-1 rounded-sm"><Text className="text-white">Style</Text></View>
                </View>
                <Text>Discover the key accessories that can elevate your style effortlessly.</Text>
                <Text>📚</Text>
              </View>
            </View>
            <View className="flex-row w-full space-x-3 border-b border-b-black/20 py-4">
