  ...
  return (
    <SafeAreaView className="flex-1 bg-white">
      <ScrollView className="p-4">
        ...
        <View className="my-4 overflow-hidden border-8">
          <Text className="text-lg font-extrabold">Featured Products</Text>
          <Image source={require('@/assets/images/feedImage.jpg')} style={{width: '100%', height: 400, objectFit: 'cover', borderRadius: 8, position: 'relative'}}  />
          <Text className="absolute top-7 left-0 bg-sky-400 text-white p-1">Limited Edition</Text>
        </View>
      </ScrollView>
    </SafeAreaView>
  );
