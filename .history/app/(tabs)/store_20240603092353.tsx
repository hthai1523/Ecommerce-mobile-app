...
const Store = () => {
  ...
  const handleScroll = (e:NativeEvent) => {
      const offsetY = e.
  }
      ...
      <View className="mt-[53]">
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          <Slider />
           ...
           <TouchableOpacity className=" bg-black rounded-full items-center justify-center" style={{width: 50, height: 50, display: }}>
            <Text>top</Text>
          </TouchableOpacity>

          <Separate color="#EEE" />

          <ShoppingList data={listProductArrivals} isLoading={isLoading} title="Sale Now" isNavigation={false} />
