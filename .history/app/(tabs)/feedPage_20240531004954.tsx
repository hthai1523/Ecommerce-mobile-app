    ...
    <SafeAreaView className="flex-1 bg-white">
      <Stack.Screen
        options={{
          headerTitle: "",
          headerLeft: () => (
            <Text className="text-[#ADADAD] text-lg font-medium p-4">
              New Feeds
            </Text>
          ),
          headerRight: () => (
      ...
      <ScrollView className="p-4">
        ...
        <View className="my-4 space-y-4 ">
          ...
          <View style={styles.featuredContainer} className="space-y-2 pb-4">
            <View className="relative overflow-hidden rounded-md ">
              ...
              />
              <Text className="absolute top-0 left-0 bg-sky-400 text-white p-1 ">
                Limited Edition
              </Text>
            </View>
        ...
        <View className="my-4 space-y-4">
          ...
          <View className="flex-row w-full space-x-3 border-b border-b-black/20 py-4">
            <Image
              source={{
                uri: "https://th.bing.com/th/id/OIP.MkqxKliP-coG1uCo7Hin3AHaFj?rs=1&pid=ImgDetMain",
              }}
            ...
            <View className="flex-1">
              ...
              <View className="flex-row items-center gap-2">
                <View className="bg-sky-400  p-1 rounded-sm">
                  <Text className="text-white">Accessories</Text>
                </View>
                <View className="bg-sky-400  p-1 rounded-sm">
              ...
              <Text>
                Discover the key accessories that can elevate your style
                effortlessly.
              </Text>
              <Text>📚</Text>
            </View>
