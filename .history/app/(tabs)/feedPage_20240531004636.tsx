            ...
            <View className="flex-row w-full space-x-3">
              ...
              <View className="flex-1">
                ...
                <View className="flex-row items-center gap-2">
                  <View className="bg-sky-400  p-1 rounded-md"><Text className="text-white">Accessories</Text></View>
                  <View className="bg-sky-400  p-1 rounded-md"><Text className="text-white">Style</Text></View>
                </View>
