        ...
        options={{
          ...
          headerRight: () => (
            <View className="flex-row items-center mr-1">
              <TouchableOpacity onPress={() => router.push('/(modals)/settingAccount')} style={{ padding: 8 }}>
                <Feather
                  name="settings"
                  size={20}
          ...
          {user ? (
            <>
              ...
              <View className="flex-1 gap-1">
                ...
                <TouchableOpacity onPress={logOut} className="flex-row items-center space-x-1">
                  <MaterialIcons name="logout" size={20} color="red" />
                  <Text>Logout</Text>
                </TouchableOpacity>
                <TouchableOpacity onPress={() => router.push('/(modals)/settingAccount')} className="flex-row items-center space-x-1">
                  <Feather name="shield" size={20} color={Colors.primary.icon}/>
