                ...
                options={{
                    tabBarIcon: ({focused}) => (
                        <View style={{ alignItems: "center", paddingTop: 10, width: 60, height: 60, borderRadius: 999, backgroundColor: Colors.primary.background, marginBottom: 35 }}>
                            <Ionicons name={focused ? "bag-handle" : "bag-handle-outline"} color={focused ? Colors.primary.background : "white"} size={24}/>
                            <Text
                            style={{
                                color: focused ? Colors.primary.background : "white",
                                fontSize: 12,
                                marginTop: 4
                            }}
                            >Store</Text>
