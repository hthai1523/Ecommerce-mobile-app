  ...
  const handleChangePassword = async () => {
    if (user && auth.currentUser) {
      try {
        ...
        setPassword("");
        Alert.alert("Password updated successfully", "You should reboot to use the new password");
      } catch (error: any) {
                ...
                <View className="flex-1">
                  ...
                  <View className="flex-row w-full  ">
                    ...
                    <View className="flex-row items-center">
                      ...
                      <TouchableOpacity onPress={handleChangePassword} style={styles.sendButton}>
                        <Feather
                          name="send"
                          size={20}
                          color={Colors.primary.icon}
